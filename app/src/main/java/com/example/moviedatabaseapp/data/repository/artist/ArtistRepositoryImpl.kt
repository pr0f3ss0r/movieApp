package com.example.moviedatabaseapp.data.repository.artist
...
class ArtistRepositoryImpl(
    ...
    suspend fun getArtistsFromAPI():List<Artist>{
        ...
        try {
            ...
            Log.e("getArtistsFromAPI:", e.message.toString(), )
        }
        return artistList
    }
    ...
    suspend fun getArtistsFromDB():List<Artist>{
        ...
        try {
            ...
            Log.e("getArtistsFromDB:", e.message.toString(), )
        }
    ...
    suspend fun getArtistsFromCache():List<Artist>{
        ...
        try {
            ...
            Log.e("getArtistsFromCache:", e.message.toString(), )
        }
        if(artistList.size > 0){
            return artistList
        }else{
